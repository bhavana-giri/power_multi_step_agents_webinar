...
|---|---|---|
| Backed by | RedisVL `MessageHistory` / `SemanticMessageHistory` | Redis Agent Memory (Redis Cloud) |
...
| Retrieval | Recency window + in-session semantic recall | Hybrid: meaning + metadata + recency |
